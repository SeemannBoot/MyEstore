				...
				<div class="block">
					<div class="f_l left_login">
						...
						<c:if test="${not empty loginUser }">
							${loginUser.nickname }| <a href="loginOut.jsp">退出</a>
						</font>
						</c:if>
					...
					<div class="header_r">
						<a href="queryOrdersServlet">我的订单</a>
						<a href="${pagecContext.request.contextPath }queryGoodsServlet">商品列表</a>
					</div>
				</div>
			</div>
		</div>
			...
			<ul class="cart_info">
				<li id="ECS_CARTINFO">
					<div class="top_cart">
						...
						<a href="queryCartServlet" class="shopborder">去购物车结算</a>
					</div>
				</li>
			</ul>
		</div>
