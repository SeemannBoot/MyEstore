	...
	function checkName(username){
		ajax({
			...
			callback: function(result) {
				...
				if(result == 0) {
					cunzai = false;
					document.getElementById("username_notice").innerHTML = "OK";
				} else {
					cunzai = true;
	...
	<div class="block block1">
		...
		<div class="usBox">
			<div class="usBox_1">
				...
				<form action="regServlet" method="post" name="formUser"
					onsubmit="return !cunzai && register();">
					<table width="100%" border="0" align="left" cellpadding="5"
						cellspacing="3">
						<tr>
							<td width="25%" align="right">用户名</td>
							<td width="65%"><input name="username" type="text"
								id="username" onblur="if( is_registered(this.value) ) {checkName(value);}"
