...
<div class="AreaR" style="width:950px;">
	...
	<div id="goodsInfo" class="clearfix">
		...
		<div class="imgInfo">
			<!-- 当前显示的大图 -->
			<a href="${pageContext.request.contextPath }${good.imgurl}"
				id="zoom1" class="MagicZoom MagicThumb">
				<img src="${pageContext.request.contextPath }${good.imgurl}"
		...
		<div class="textInfo">
			...
			<ul class="bnt_ul">
				...
				<li class="clearfix">
					<dd>
						<strong>购买数量：</strong>
						<input name="buynum" id="buynum" size="4" 
						onkeypress="return !isNaN(String.fromCharCode(event.keyCode || event.which))"
						onkeyup="value=value.replace(/\D/g,''); if(value=='' || value > 50) value=1;" value="1" />
					</dd>
				</li>
				<li class="padd">
				<script type="text/javascript">
					function _buy() {
						location="buyGoodsServlet?id=${good.id}&num="+document.getElementById("buynum").value;
					}
				</script>
					<a href="javascript:;" onclick="_buy();">
